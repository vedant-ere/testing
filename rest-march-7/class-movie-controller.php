...
class Movie_Controller extends Base_Cpt_Controller {
	...
	/**
	 * Expose allowed taxonomies to handler classes.
	 *
	 * @return array<int, string>
	 */
	public function get_allowed_taxonomies(): array {
		return parent::get_allowed_taxonomies();
	}
	...
	/**
	 * Public proxy for prepare_item_data() (needed by Movie_Merge_Handler).
	 *
	...
	protected function get_additional_response_schema(): array {
		return array(
			...
			'gallery_image_urls' => array( 'type' => 'array', 'items' => array( 'type' => 'string' ) ),
			...
			'gallery_video_urls' => array( 'type' => 'array', 'items' => array( 'type' => 'string' ) ),
