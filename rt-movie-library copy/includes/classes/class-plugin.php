...
use RT_Movie_Library\Classes\Database\Meta_Sync;
...
class Plugin {
	...
	public function register() {
		...
		// Boot the meta lifecycle handler: handles cache invalidation on save
		// and custom-table cleanup on post deletion.
		Meta_Sync::get_instance();
	}
}
