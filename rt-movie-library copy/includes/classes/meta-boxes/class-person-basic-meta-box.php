...
class Person_Basic_Meta_Box {
	...
	public function render( WP_Post $post ): void {
		...
		$full_name   = Meta_Repository::get( $post->ID, 'rt-person-meta-full-name', true );
		$birth_date  = Meta_Repository::get( $post->ID, 'rt-person-meta-basic-birth-date', true );
		$birth_place = Meta_Repository::get( $post->ID, 'rt-person-meta-basic-birth-place', true );
		?>
