...
class Movie_Shortcode {
	...
	public function render( array $atts ): string {
		...
		foreach ( $query->posts as $post ) {
			...
			$directors = json_decode( (string) Meta_Repository::get( $post_id, 'rt-movie-meta-crew-director', true ), true );
			$actors    = json_decode( (string) Meta_Repository::get( $post_id, 'rt-movie-meta-crew-actor', true ), true );
			...
			$movies[] = array(
				...
				'release_date' => Meta_Repository::get( $post_id, 'rt-movie-meta-basic-release-date', true ),
				'directors'    => $directors,
				'actors'       => $actors,
			);
		}
	 ...
	 * @return string|null Shadow slug or null when not found.
	 */
