...
abstract class Base_Cpt_Controller extends WP_REST_Controller {
	...
	public function get_item_schema() {
		...
		$properties = array(
			...
			'date_gmt'       => array( 'type' => 'string', 'readonly' => true ),
			'modified_gmt'   => array( 'type' => 'string', 'readonly' => true ),
			'link'           => array( 'type' => 'string', 'readonly' => true ),
			'meta'           => array(
				'type'                 => 'object',
	...
	public function create_item( $request ) {
		...
		if ( is_wp_error( $post_id ) ) {
			return new WP_Error( 'rt_rest_create_failed', __( 'Failed to create item.', 'rt-movie-library' ), array( 'status' => 400, 'details' => $post_id->get_error_message() ) );
		}
	...
	public function update_item( $request ) {
		...
		if ( is_wp_error( $result ) ) {
			return new WP_Error( 'rt_rest_update_failed', __( 'Failed to update item.', 'rt-movie-library' ), array( 'status' => 400, 'details' => $result->get_error_message() ) );
		}
