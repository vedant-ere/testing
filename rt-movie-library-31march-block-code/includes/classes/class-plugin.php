...
use RT_Movie_Library\Classes\Rest\{ Cpt_Endpoints, Block_Data_Controller };
use RT_Movie_Library\Classes\Blocks\Blocks_Registrar;
...
class Plugin {
	...
	protected function __construct() {
		// Blocks must attach to `init` before `init` runs, otherwise they can miss
		// registration entirely if booted from inside another `init` callback.
		Blocks_Registrar::get_instance();
	...
	public function register() {
		...
		Block_Data_Controller::get_instance();
