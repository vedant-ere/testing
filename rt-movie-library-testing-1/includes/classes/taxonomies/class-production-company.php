...
class Production_Company {
	...
	public function register() {
		...
		$args = array(
			...
			'query_var'         => true,
			'capabilities'      => array(
				'manage_terms' => 'manage_rt-movie-production-company',
				'edit_terms'   => 'manage_rt-movie-production-company',
				'delete_terms' => 'manage_rt-movie-production-company',
				'assign_terms' => 'assign_rt-movie-production-company',
			),
			'rewrite'           => array(
