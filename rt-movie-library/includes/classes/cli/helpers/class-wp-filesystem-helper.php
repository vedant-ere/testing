...
class Wp_Filesystem_Helper {
	...
	public function write_csv_row_to_stream( $handle, array $row, string $path ): void {
		// phpcs:ignore WordPress.WP.AlternativeFunctions.file_system_operations_fputcsv,WordPressVIPMinimum.Functions.RestrictedFunctions.file_ops_fputcsv -- Intentional: native CSV writer with streaming keeps export memory constant; path is controlled by CLI arguments/uploads.
