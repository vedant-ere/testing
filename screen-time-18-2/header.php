		...
		<div class="container site-header__top-inner">
			...
			<div class="site-header__actions">
				...
				<button class="header-menu-toggle" type="button" data-mobile-menu-toggle aria-expanded="false" aria-controls="mobile-menu-panel" aria-label="<?php esc_attr_e( 'Open menu', 'screen-time' ); ?>">
					...
					<span class="header-icon" aria-hidden="true">
						<svg fill="#ffffffff" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"><title>right-align</title><path d="M0 6.016v-4h32v4h-32zM4 22.016v-4h28v4h-28zM8 14.016v-4h24v4h-24zM12 30.016v-4h20v4h-20z"></path></svg>
					</span>
				</button>
			</div>
		</div>
