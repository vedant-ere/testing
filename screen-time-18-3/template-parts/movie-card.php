...
if ( ! empty( $args ) && is_array( $args ) ) {
	...
	$movie_runtime  = screentime_get_movie_runtime_label( $post_id );
	$movie_subtitle = screentime_get_movie_release_label( $post_id );
	$movie_image    = screentime_get_movie_image_url( $post_id, 'screentime-movie-card', false );
