...
( () => {
	...
	const i18n = Object.assign(
		{
			loadMore: String( uiI18n.loadMore || 'Load More' ),
			loading: String( uiI18n.loading || 'Loading...' ),
			learnMore: String( uiI18n.learnMore || 'Learn more' ),
			bornPrefix: String( uiI18n.bornPrefix || 'Born -' ),
			error: String( uiI18n.error || 'Unable to load more people right now.' ),
			noMore: String( uiI18n.noMore || 'No more people to load.' ),
		},
		config.i18n || {}
	);
