...
require_once SCREENTIME_PATH . '/inc/traits/trait-singleton.php';
...
require_once SCREENTIME_PATH . '/inc/reviews-ajax.php';
require_once SCREENTIME_PATH . '/inc/widget-recommendations-base.php';
require_once SCREENTIME_PATH . '/inc/widget-movie-recommendations.php';
require_once SCREENTIME_PATH . '/inc/widget-person-recommendations.php';
require_once SCREENTIME_PATH . '/inc/widgets.php';

// Instantiate singletons.
Screen_Time_Customizer::get_instance();
