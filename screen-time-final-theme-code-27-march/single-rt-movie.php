						...
						<p class="movie-single-hero__directors">
							...
							<?php foreach ( $directors as $director_index => $director_post ) : ?>
								<?php if ( $director_index > 0 ) : ?>
									<span aria-hidden="true"> <?php echo esc_html( screentime_get_separator() ); ?> </span>
								<?php endif; ?>
...
<?php
if ( ! $is_cast_crew_view && is_active_sidebar( 'screentime-movie-recommendations' ) ) {
	dynamic_sidebar( 'screentime-movie-recommendations' );
}
?>
