...
<p class="has-heebo-font-family has-base-font-size"><?php echo esc_html__( 'Follow Us', 'screen-time-fse' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-base-font-size"><?php echo esc_html__( 'COMPANY', 'screen-time-fse' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column"><!-- wp:group {"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"base"} -->
<p class="has-base-font-size"><?php echo esc_html__( 'EXPLORE', 'screen-time-fse' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-heebo-font-family"><?php echo esc_html__( '© 2026 ScreenTime. All Rights Reserved. Terms of Service | Privacy Policy', 'screen-time-fse' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->