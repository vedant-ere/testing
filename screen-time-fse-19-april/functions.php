 ...
 * @return void
 */
function screentime_fse_load_textdomain(): void {
	load_theme_textdomain( 'screen-time-fse', SCREENTIME_FSE_PATH . '/languages' );
}
add_action( 'after_setup_theme', 'screentime_fse_load_textdomain' );
...
function screentime_fse_enqueue_assets(): void {
	...
	// Enqueue mobile header JS for drawer/accordion functionality.
	wp_enqueue_script(
