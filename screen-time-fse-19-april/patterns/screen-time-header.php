	...
	<div class="wp-block-group desktop-header-only has-page-bg-background-color has-background">
		...
		<div class="wp-block-group header-top-bar has-page-bg-background-color has-background" style="min-height:120px">
			...
			<div class="wp-block-group">
				...
				<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/search.png' ); ?>" alt="<?php esc_attr_e( 'Search', 'screen-time-fse' ); ?>" class="wp-image-343"/></figure>
				<!-- /wp:image -->
			...
			<div class="wp-block-group header-actions-desktop">
				...
				<div class="wp-block-group">
					...
					<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/user.png' ); ?>" alt="<?php esc_attr_e( 'User account', 'screen-time-fse' ); ?>" class="wp-image-537"/></figure>
					<!-- /wp:image -->
	...
	<div class="wp-block-group mobile-header-only">
		...
		<div class="mobile-header-bar">
			<div class="mobile-search-trigger">
				<img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/search.png' ); ?>" alt="<?php esc_attr_e( 'Search', 'screen-time-fse' ); ?>" />
			</div>
