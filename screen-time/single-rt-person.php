				...
				<div class="person-popular-grid">
					<?php if ( $popular_movies->have_posts() ) : ?>
						<?php while ( $popular_movies->have_posts() ) : ?>
							...
							$subtitle = '' !== $subtitle ? $subtitle : screentime_get_movie_release_label( $popular_movie_id );
...
<?php
if ( is_active_sidebar( 'screentime-person-recommendations' ) ) {
	dynamic_sidebar( 'screentime-person-recommendations' );
}
?>
