...
<p class="movie-single-hero__rating-row">
	...
	<?php if ( ! empty( $release_year ) ) : ?>
		<span aria-hidden="true"><?php echo esc_html( screentime_get_separator() ); ?></span><span><?php echo esc_html( $release_year ); ?></span>
	<?php endif; ?>
	<?php if ( ! empty( $content_rating ) ) : ?>
		<span aria-hidden="true"><?php echo esc_html( screentime_get_separator() ); ?></span><span><?php echo esc_html( $content_rating ); ?></span>
	<?php endif; ?>
	<?php if ( ! empty( $runtime ) ) : ?>
		<span aria-hidden="true"><?php echo esc_html( screentime_get_separator() ); ?></span><span><?php echo esc_html( strtoupper( $runtime ) ); ?></span>
	<?php endif; ?>
</p>
	...
	<ul class="movie-single-hero__genres" aria-label="<?php esc_attr_e( 'Genres', 'screen-time' ); ?>">
		<?php foreach ( $genre_terms as $genre_term ) : ?>
			...
			<li>
				<button
					type="button"
					class="chip chip--outline chip--sm movie-single-hero__genre-button"
