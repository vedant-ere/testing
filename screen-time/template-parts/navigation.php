...
$default_items = array(
	array(
		...
		'url'   => get_post_type_archive_link( 'rt-movie' ),
	),
	array(
	...
	array(
		...
		'url'   => get_post_type_archive_link( 'rt-person' ),
	),
);
...
if ( 'footer_company' === $theme_location ) {
	$default_items = array(
		array(
			'label' => __( 'About Us', 'screen-time' ),
			'url'   => '#',
		),
		array(
			'label' => __( 'Team', 'screen-time' ),
			'url'   => '#',
		),
		array(
			'label' => __( 'Careers', 'screen-time' ),
			'url'   => '#',
		),
		array(
			'label' => __( 'Culture', 'screen-time' ),
			'url'   => '#',
		),
		array(
			'label' => __( 'Community', 'screen-time' ),
			'url'   => '#',
		),
	);
}
...
if ( 'footer_bottom' === $theme_location ) {
	$default_items = array(
		array(
			'label' => __( 'Terms of Service', 'screen-time' ),
			'url'   => '#',
		),
		array(
			'label' => __( 'Privacy Policy', 'screen-time' ),
			'url'   => '#',
		),
	);
}
